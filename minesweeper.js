...
const minePercentage = 0.148; //el porcentaje de minas
let mines = Math.floor(grid * minePercentage); // numero de minas que usara el juego
...
replay.addEventListener('click', () => {
    cells = [];
    board.innerHTML = "";
    mines = Math.floor(grid * minePercentage);
    firstClick = false;
    game = "not started";
